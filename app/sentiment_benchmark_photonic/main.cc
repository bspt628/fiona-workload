/**
 * @file main.cc
 * @brief Sentiment Classification Benchmark with Photonic Acceleration
 *
 * Full SST-2 validation set evaluation using FIONA photonic MVM operations.
 * Photonic model can be selected via environment variable:
...
void multihead_attention_photonic(
    ...
    // Attention computation per head (ELECTRONIC)
...
int main() {
    ...
    printf("Execution mode: PHOTONIC (FIONA MVM)\n");
    printf("  Model selected via FIONA_PHOTONIC_MODEL env var\n");
    printf("  Available: ideal, noisy, mzi_realistic, quantized\n\n");
    ...
    printf("\n============================================\n");
    printf("  RESULTS (Photonic Execution)\n");
    printf("============================================\n\n");
